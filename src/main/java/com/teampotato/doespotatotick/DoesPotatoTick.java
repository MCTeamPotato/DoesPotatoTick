    ...
    public DoesPotatoTick() {
        ...
        MinecraftForge.EVENT_BUS.addListener((PlayerEvent.PlayerLoggedInEvent event) -> {
            ...
            if (IS_FTB_CHUNKS_PRESENT) {
                event.getPlayer().displayClientMessage(new TranslatableComponent("doespotatotick.warn.1"), false);
            } else {
                event.getPlayer().displayClientMessage(new TranslatableComponent("doespotatotick.warn.2"), false);
            }
        });
    }
